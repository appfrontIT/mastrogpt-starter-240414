...
Choose the correct function based on the type of API:
    ...
    - if the action make a query to the database such as 'https://nuvolaris.dev/api/v1/web/gporchia/db/mongo' call the db_test function. you need to perform the tests in this order:
