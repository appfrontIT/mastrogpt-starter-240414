...
Test must be formatted as a Python Dictionary. Use double quotes (") to encapsulate keys! Example:
    - {"method": method, "url": url, "headers": headers, "body": {"arg1": arg1, "arg2": arg2, "arg3": arg3}, "output": output}
